...
do
    ...
    do
        ...
        do
            for va in "${vas[@]}"
            do
                input=/work/lfrechette/lj-assembly-results/kT\=${kT}/phi\=${phi}/va\=${va}/tau\=${tau}/lambda\=${lambda}/Lx\=${Lx}_Ly\=${Ly}/nx\=${nx}_ny\=${ny}/seed\=1/prod
                sbatch /home/lfrechette/lj_assembly/scripts/submit_get_msd.sh $input 100
